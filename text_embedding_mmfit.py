...
sentences = [['Represent human activity sentence for clustering: ','The body is lowered at the hips from a standing position and then stands back up to complete a repetition. Hands are push in front for balancing.'],
